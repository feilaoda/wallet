        ...
        <Swiper loop={false} activeDotColor="#2ACFFF">
            <View style={{justifyContent:'center',alignItems:'center',height:'100%'}}>
                <View style={{height:'30%',justifyContent:'center',alignItems:'center'}}>
                    ...
                    <Text style={{color:"#4e5e7d",fontSize:18,marginTop:30,textAlign:'center'}}>资产自己作主，更能随心所欲</Text>
                    <Text style={{color:"#4e5e7d",fontSize:18,textAlign:'center',marginTop:10}}>去中心化钱包，无第三方留存</Text>
                </View>
            ...
            <View style={{justifyContent:'center',alignItems:'center',height:'100%'}}>
                <View style={{height:'30%',justifyContent:'center',alignItems:'center'}}>
                    ...
                    <Text style={{color:"#4e5e7d",fontSize:18,marginTop:30,textAlign:'center'}}>快速转账，无手续费</Text>
                    <Text style={{color:"#4e5e7d",fontSize:18,textAlign:'center',marginTop:10}}>百万级高并发无压力</Text>
                </View>
                <View style={{height:'50%',alignItems:'center'}}>
            ...
            <View style={{justifyContent:'center',alignItems:'center',height:'100%'}}>
                <View style={{height:'30%',justifyContent:'center',alignItems:'center'}}>
                    ...
                    <Text style={{color:"#4e5e7d",fontSize:18,marginTop:30,textAlign:'center'}}>您最关心的EOS独家情报</Text>
                    <Text style={{color:"#4e5e7d",fontSize:18,textAlign:'center',marginTop:10}}>最新、最快、最全面</Text>
                </View>
                <View style={{height:'50%',alignItems:'center'}}>
            ...
            <View style={{justifyContent:'center',alignItems:'center',height:'100%'}}>
                <View style={{height:'30%',justifyContent:'center',alignItems:'center'}}>
                    ...
                    <Text style={{color:"#4e5e7d",fontSize:18,marginTop:30,textAlign:'center'}}>您的EOS数字资产管家</Text>
                </View>
                <View style={{height:'50%',alignItems:'center'}}>
