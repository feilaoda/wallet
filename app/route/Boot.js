    ...
    return (
      <View style={styles.container}>
        <Swiper loop={false} activeDotColor={UColor.tintColor}>
            ...
            <View style={{justifyContent:'center',alignItems:'center',height:'100%'}}>
                <View style={{height:'30%',justifyContent:'center',alignItems:'center'}}>
                    <Text style={{color:UColor.fontColor,fontSize:24,textAlign:'center'}}>世界的另一头，近在咫尺</Text>
                    <Text style={{color:UColor.mainColor,fontSize:18,marginTop:30,textAlign:'center'}}>快速转账，无手续费</Text>
                    <Text style={{color:UColor.mainColor,fontSize:18,textAlign:'center',marginTop:10}}>百万级高并发无压力</Text>
                </View>
                <View style={{height:'50%',alignItems:'center'}}>
            ...
            <View style={{justifyContent:'center',alignItems:'center',height:'100%'}}>
                <View style={{height:'30%',justifyContent:'center',alignItems:'center'}}>
                    <Text style={{color:UColor.fontColor,fontSize:24,textAlign:'center'}}>您关心的EOS资讯</Text>
                    <Text style={{color:UColor.mainColor,fontSize:18,marginTop:30,textAlign:'center'}}>您最关心的EOS独家情报</Text>
                    <Text style={{color:UColor.mainColor,fontSize:18,textAlign:'center',marginTop:10}}>最新、最快、最全面</Text>
                </View>
                <View style={{height:'50%',alignItems:'center'}}>
