...
class Coins extends BaseComponent {
  ...
  renderScene = ({ route }) => {
    ...
    if (route.key == '0') {
      const v = <View style={styles.container}>
          <View style={{ backgroundColor: UColor.secdColor,}}>
            <View style={{ backgroundColor: UColor.mainColor,paddingLeft: 15, paddingRight: 15,}}>
              <View style={{ paddingTop: 20, height: 60, backgroundColor: UColor.mainColor, borderBottomWidth:0.5,borderBottomColor: UColor.secdColor,}}>
                <TextInput ref={(ref) => this._lphone = ref} autoFocus={false} editable={true}
                  ...
                  returnKeyType="next" selectionColor={UColor.tintColor} style={{ color: UColor.arrow, fontSize: 15, height: 40, paddingLeft: 10, }}
                  placeholderTextColor={UColor.arrow} placeholder="助记词，按空格分隔" underlineColorAndroid="transparent" keyboardType="phone-pad" 
                />
              </View>
              <View style={{ paddingTop: 20, height: 60, backgroundColor: UColor.mainColor, borderBottomWidth:0.5,borderBottomColor: UColor.secdColor,}} >
                <TextInput ref={(ref) => this._lphone = ref} autoFocus={false} editable={true}
              ...
              <View style={{ paddingTop: 20, height: 60, backgroundColor: UColor.mainColor, borderBottomWidth:0.5,borderBottomColor: UColor.secdColor,}}>
                <TextInput ref={(ref) => this._lpass = ref} autoFocus={false} editable={true}
                  ...
                  returnKeyType="go" selectionColor={UColor.tintColor} style={{ color: UColor.arrow, fontSize: 15, height: 40, paddingLeft: 10 }} placeholderTextColor={UColor.arrow}
            ...
            <Button onPress={() => this.importByWords()}>
              <View style={{ height: 45, backgroundColor: UColor.tintColor, justifyContent: 'center', alignItems: 'center', marginTop: 20, marginLeft: 20, marginRight: 20, borderRadius: 5 }}>
                <Text style={{ fontSize: 15, color: UColor.fontColor }}>创建钱包</Text>
              </View>
            </Button>
            <Button onPress={() => this.prot(this,'Memorizingwords')}>
              <View style={{ height: 45, backgroundColor: UColor.secdColor, justifyContent: 'center', alignItems: 'center', margin: 20, borderRadius: 5 }}>
                <Text style={{ fontSize: 15, color: UColor.tintColor, }}>什么是助记词？</Text>
              </View>
            </Button>
          </View>
      </View>
    ...
    //       <View>
    //         <Text style={styles.welcome} style={{ color: UColor.arrow, margin: 10, fontSize: 15 }}>直接复制粘贴以太坊官方钱包 Keystore 文件内 容至输入框。或者通过生成 Keystore 内容的二 维码，扫描录入。</Text>
    //         <View style={{ backgroundColor: UColor.secdColor, }}>
    //           <View style={{ padding: 20, height: 100, backgroundColor: UColor.mainColor, marginLeft: 10, marginRight: 10, marginTop: 20, marginBottom: 20 }} >
    //             <TextInput ref={(ref) => this._lphone = ref} autoFocus={false} editable={true}
    ...
    //               placeholderTextColor={UColor.arrow} placeholder="Keystore 文本内容" underlineColorAndroid="transparent" keyboardType="phone-pad" maxLength={11}
    //             />
    //           </View>
    //           <View style={{ padding: 20, height: 60, backgroundColor: UColor.secdColor, }} >
    //             <TextInput ref={(ref) => this._lphone = ref} autoFocus={false} editable={true}
    //               // value={this.state.loginPhone} 
    //               returnKeyType="next" selectionColor={UColor.tintColor} style={{ color: UColor.arrow, fontSize: 15, height: 40, paddingLeft: 2 }}
    //               placeholderTextColor={UColor.arrow} placeholder="Keystore 密码" underlineColorAndroid="transparent" keyboardType="phone-pad" maxLength={11}
    //             />
    //           </View>
    //           <View style={{ height: 0.5, backgroundColor: UColor.secdColor, flex: 1, flexDirection: 'column', }}></View>
    //           <Text style={styles.welcome} style={{ alignContent: 'center' }}>我已经仔细阅读并同意 服务及隐私条款</Text>
    //         </View>
    //         <Button onPress={() => this.logout()}>
    //           <View style={{ height: 45, backgroundColor: UColor.tintColor, justifyContent: 'center', alignItems: 'center', marginTop: 20, marginLeft: 20, marginRight: 20, borderRadius: 5 }}>
    //             <Text style={{ fontSize: 15, color: UColor.fontColor }}>开始导入</Text>
    //           </View>
    //         </Button>
    //         <Button onPress={() => this.logout()}>
    //           <View style={{ height: 45, backgroundColor: UColor.secdColor, justifyContent: 'center', alignItems: 'center', margin: 20, borderRadius: 5 }}>
      ...
      const v = <View style={styles.container}>
          <View style={{ backgroundColor: UColor.secdColor,}}>
            <View style={{ backgroundColor: UColor.mainColor,paddingLeft: 15, paddingRight: 15,}}>
              <View style={{ paddingTop: 20, height: 60, backgroundColor: UColor.mainColor, borderBottomWidth:0.5,borderBottomColor: UColor.secdColor,}} >
                <TextInput ref={(ref) => this._lphone = ref} autoFocus={false} editable={true}
                  ...
                  returnKeyType="next" selectionColor={UColor.tintColor} style={{ color: UColor.arrow, fontSize: 15, height: 40, paddingLeft: 10,}}
                  placeholderTextColor={UColor.arrow} placeholder="owner私钥明文" underlineColorAndroid="transparent" keyboardType="phone-pad" 
                />
              </View>
              <View style={{ paddingTop: 20, height: 60, backgroundColor: UColor.mainColor, borderBottomWidth:0.5,borderBottomColor: UColor.secdColor,}} >
                <TextInput ref={(ref) => this._lphone = ref} autoFocus={false} editable={true}
                  ...
                  returnKeyType="next" selectionColor={UColor.tintColor} style={{ color: UColor.arrow, fontSize: 15, height: 40, paddingLeft: 10 }}
                  placeholderTextColor={UColor.arrow} placeholder="active私钥明文" underlineColorAndroid="transparent" keyboardType="phone-pad" 
                />
              </View>
              <View style={{ paddingTop: 20, height: 60, backgroundColor: UColor.mainColor, borderBottomWidth:0.5,borderBottomColor: UColor.secdColor,  }} >
                <TextInput ref={(ref) => this._lpass = ref} autoFocus={false} editable={true}
            ...
            <View style={{flexDirection: 'row',justifyContent: 'center', alignItems: 'center', marginTop: 20,}}>
              ...
              <Text style={styles.welcome} style={{ fontSize: 15, color: UColor.arrow, marginLeft: 10 }}>我已经仔细阅读并同意</Text>
              <Text onPress={() => this.prot(this,'clause')} style={{ fontSize: 15, color: UColor.tintColor, marginLeft: 5 }}>服务及隐私条款</Text>
            </View> 
            ...
            <Button onPress={() => this.prot(this,'privatekey')}>
              <View style={{ height: 45, backgroundColor: UColor.secdColor, justifyContent: 'center', alignItems: 'center', margin: 20, borderRadius: 5 }}>
                <Text  style={{ fontSize: 15, color: UColor.tintColor }}>什么是私钥？</Text>
              </View>
            </Button>
          </View>
      </View>
    ...
    //     <ScrollView style={styles.scrollView}>
    //       <View>
    //         <Text style={styles.welcome} style={{ margin: 20, color: UColor.arrow, fontSize: 15 }}>观察钱包不需要导入私钥，只导入钱包地址，进行日 常查看账户、交易和授受通知。大额资金的私钥建议 使用冷钱包或硬件钱包管理，避免泄露被盗。</Text>
    //         <View style={{ backgroundColor: UColor.secdColor, }}>
    //           <View style={{ padding: 20, height: 60, backgroundColor: UColor.mainColor }} >
    //             <TextInput ref={(ref) => this._lphone = ref} autoFocus={false} editable={true}
    //               // value={this.state.loginPhone} 
    //               returnKeyType="next" selectionColor={UColor.tintColor} style={{ color: UColor.arrow, fontSize: 15, height: 40, paddingLeft: 2 }}
    //               placeholderTextColor={UColor.arrow} placeholder="输入钱包地址" underlineColorAndroid="transparent" keyboardType="phone-pad" maxLength={11}
    //             />
    //           </View>
    //           <View style={{ height: 0.5, backgroundColor: UColor.secdColor, flex: 1, flexDirection: 'column', }}></View>
    //         </View>
    ...
    //           <Text style={styles.welcome} style={{ color: UColor.arrow, padding: 10 }}>注意：观察钱包发送交易时需要冷钱包配合 签名。您可以使用另一台闲置手机，开飞行 模式作为冷钱包，导入钱包私钥，配合离线 签名。</Text>
    //         </View>
    //       </View>
    //     </ScrollView>
    //   </View>
